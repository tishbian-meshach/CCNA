2.9.1 Packet Tracer - Basic Switch and End Device Configuration [Answer](https://itexamanswers.net/2-9-1-packet-tracer-basic-switch-and-end-device-configuration-instructions-answer.html)
